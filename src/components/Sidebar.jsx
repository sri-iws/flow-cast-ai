...
export default function Sidebar({ view, onNavigate, user, allowedViews = navItems.map(([id]) => id) }) {
  ...
  return <aside className="sidebar">
    <div className="brand-lockup"><div className="brand-mark"><span /><span /><span /></div><div><strong style={{color: "white !important"}}>flow cast</strong><small>inventory intelligence</small></div></div>
